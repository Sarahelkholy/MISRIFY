...
class ConfirmOrderScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalBeforeCoupon = subtotal - discount;
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          border: const OutlineInputBorder(
                              borderSide:
                                  BorderSide(color: Kbackground, width: .5)),
                          enabledBorder: const OutlineInputBorder(
                              borderSide:
                                  BorderSide(color: Kbackground, width: .5)),
                          focusedBorder: const OutlineInputBorder(
                              borderSide:
                                  BorderSide(color: kLightGray, width: .5)),
                            ...
                            children: [
                              RadioListTile<String>(
                                title: ReusableText(
                                  ...
                                  style:
                                      appStyle(14, kDarkBlue, FontWeight.w400),
                                ),
                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildPriceRow('Shipping Fee :', 'EGP 0.00'),
